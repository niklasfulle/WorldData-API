    ...
    <div className="backdrop-blur-sm bg-white/75 dark:bg-slate-900/75 dark:text-white border-t border-slate-300 dark:border-slate-700 shadow-sm">
      <div className="flex flex-col py-4 px-20">
        <div className="flex justify-evenly items-start flex-wrap flex-row w-full text-center mb-8">
          <div className=" w-36 m-1 flex justify-start flex-col dark:text-white">
          ...
          <div className="w-36 m-1 flex items-center flex-col dark:text-white">
            <h4 className="text-md mb-1.5 text">Theme</h4>
            <ThemeToggleFooter />
          </div>
          <div className="w-56 m-1 flexflex-col dark:text-white justify-center">
        ...
        <div className="flex flex-row justify-between mt-0 px-4">
          ...
          <div className="flex flex-col md:flex-row w-52 md:w-96 items-end  md:justify-between">
            <Link href="/info/terms-conditions" className="text-sm mb-1 mr-1">
              Terms & Conditions
            </Link>
            <Link href="/info/privacy" className="text-sm mb-1 mr-1">
              Privacy Policy
            </Link>
            <Link href="/info/security" className="text-sm mb-1 mr-1">
              Security
            </Link>
            <Link href="/info/cookies" className="text-sm mb-1 mr-1">
              Cookies
            </Link>
          </div>
        </div>
