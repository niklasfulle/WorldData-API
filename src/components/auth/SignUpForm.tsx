  ...
  return (
    <div className="flex min-h-full flex-col items-center justify-center rounded-lg bg-white px-6 py-6 dark:bg-slate-600 lg:px-8">
      ...
      <div className="mt-3 sm:mx-auto sm:w-full sm:max-w-sm">
        <form
          className="space-y-6"
          onSubmit={(e) => registerWithCredentials(e, setIsLoading)}
        >
          <div>
            <label
              htmlFor="username"
          ...
          <div>
            ...
            <div className="mt-1">
              <Input
                ...
                autoComplete="email"
                required
                className="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 transition-all ease-in placeholder:text-gray-400 focus:ring-indigo-600 dark:focus:ring-sky-400 dark:focus:ring-offset-slate-700 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
        ...
        <div className="inline-flex w-full items-center justify-center">
          <hr className="my-6 h-px w-64 border-0 bg-gray-500 dark:bg-gray-300" />
