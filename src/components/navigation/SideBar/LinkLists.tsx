...
export const AdminLinkList = [
  {
    title: "Admin Panel",
    link: "/admin",
    icon: <Icons.Lock className="mr-2" />,
  },
  {
    title: "Data Panel",
    link: "/admin/data",
    icon: <Icons.Database className="mr-2" />,
  },
  {
    title: "API Statsitic",
    link: "/admin/statistic?data=api",
    icon: <Icons.Code className="mr-2" />,
  },
  {
    title: "User Statsitic",
    link: "/admin/statistic?data=user",
    icon: <Icons.BarChart3 className="mr-2" />,
  },
  {
    title: "Data Statsitic",
    link: "/admin/statistic?data=data",
    icon: <Icons.BarChart4 className="mr-2" />,
  },
];
